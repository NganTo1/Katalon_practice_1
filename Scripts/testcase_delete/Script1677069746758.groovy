...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_username'), 'sfsdfd')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input_Password_password'), 'BPBeXm1sZKU=')
